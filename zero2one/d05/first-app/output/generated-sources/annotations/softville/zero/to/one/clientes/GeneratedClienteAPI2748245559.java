...
@WebResource( path="/api/clientes/{id}/", method="DELETE" )
final public class GeneratedClienteAPI2748245559 implements HttpHandler {
    ...
    public String toString(){
        return "softville.zero.to.one.clientes.ClienteAPI.deleteClient";
    }
}