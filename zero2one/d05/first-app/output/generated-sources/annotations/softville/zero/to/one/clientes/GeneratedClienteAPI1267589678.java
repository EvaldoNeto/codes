...
@WebResource( path="/api/clientes/", method="GET" )
final public class GeneratedClienteAPI1267589678 implements HttpHandler {
	...
	private void runMethod( final HttpServerExchange exchange, final byte[] bodyData ){
		if ( exchange.isInIoThread() )
			exchange.dispatch( ()-> this.runMethod( exchange, bodyData ) );
				...
				final java.util.List response = instance.listarTodosClientes(  );
    ...
    public String toString(){
        return "softville.zero.to.one.clientes.ClienteAPI.listarTodosClientes";
    }
}