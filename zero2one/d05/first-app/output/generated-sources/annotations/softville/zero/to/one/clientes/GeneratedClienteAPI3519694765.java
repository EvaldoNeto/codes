...
@WebResource( path="/api/clientes/{id}/", method="PUT" )
final public class GeneratedClienteAPI3519694765 implements HttpHandler {
    ...
    public String toString(){
        return "softville.zero.to.one.clientes.ClienteAPI.updateCliente";
    }
}